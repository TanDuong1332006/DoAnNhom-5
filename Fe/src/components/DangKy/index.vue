<template>
  <div class="min-vh-100 d-flex flex-column align-items-center justify-content-center py-5"
    ...
    <!-- Registration Card -->
    <div class="card border-0 shadow-lg rounded-4 p-2 bg-white" style="width: 100%; max-width: 460px;">
      <div class="card-body px-4 py-4">
        ...
        <div class="text-center mb-4">
          <div class="rounded-circle bg-urbn-primary bg-opacity-10 d-inline-flex align-items-center justify-content-center mb-2"
            ...
            <i class="bx bx-user-plus text-urbn-primary" style="font-size: 2rem;"></i>
          </div>
          <h4 class="fw-extrabold text-dark mb-1 font-streetwear">Tạo Tài Khoản Mới</h4>
          <p class="text-muted small mb-0">
            Gia nhập cộng đồng URBN Metropolis &amp; nhận ngay voucher 50.000₫.
          </p>
        </div>
