    ...
    <nav class="navbar navbar-expand">
        ...
        <div class="user-box dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><router-link class="dropdown-item" to="/admin"><i class="bx bx-home-circle"></i><span>Dashboard</span></router-link></li>
                <li><router-link class="dropdown-item" to="/"><i class="bx bx-store"></i><span>Xem Cửa Hàng</span></router-link></li>
                <li>
